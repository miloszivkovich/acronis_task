...
5. Running the Tests
# pytest -v 
or can be called specificly by
...
# requirements.txt: Lists Python dependencies, and helps with instalation


Task explanations:

- Tests should be easyly scalable with new features and new scenarios
- Explicit waits were used due to Kiwi flakines with airport pickers, could have been solved in a better way
